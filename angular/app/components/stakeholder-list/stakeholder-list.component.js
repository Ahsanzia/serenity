class StakeholderListController{
...
export const StakeholderListComponent = {
    templateUrl: './views/app/components/stakeholder-list/stakeholder-list.component.html',
    controller: StakeholderListController,
    controllerAs: 'vm',
    bindings: {}
}
